...
namespace PawnShop.Controllers
{
    ...
    public class ScreenUIController2 : MonoBehaviour
    {
        [SerializeField] private CartType cartType; // <- выбирается в инспекторе
        ...
        public void Initialize(NavigationService2 navigation)
        {
            navigationService = navigation;
            canvasGroup = GetComponent<CanvasGroup>();
